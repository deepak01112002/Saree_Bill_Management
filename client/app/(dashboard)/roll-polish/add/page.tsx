...
export default function AddRollPolishPage() {
  ...
  const generateRollNumber = () => {
    ...
    return `ROLL-${year}${month}${day}-${random}`;
  };

  const handleAutoGenerateRollNumber = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showToast.success('Roll polish entry created successfully!');
      router.push('/roll-polish');
    } catch (error: any) {
      console.error('Error creating roll polish:', error);
      showToast.error('Failed to create roll polish entry: ' + (error.message || 'Unknown error'));
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Add Roll Polish Entry</h1>
          <p className="text-gray-600 mt-1">Record a new roll sent for polishing</p>
        </div>
      </div>
      ...
      <Card className="border-0 shadow-md">
        <form onSubmit={handleSubmit}>
          <CardHeader>
            ...
            <CardDescription>Enter the details for the roll being sent for polishing</CardDescription>
          </CardHeader>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    ...
                    variant="ghost"
                    size="sm"
                    onClick={handleAutoGenerateRollNumber}
                    className="text-xs"
                  >
                    Auto Generate
                  </Button>
          ...
          <CardFooter className="flex justify-end gap-2">
            ...
            <Button type="submit" disabled={loading} className="bg-gradient-to-r from-blue-600 to-purple-600">
              {loading ? 'Creating...' : 'Create Roll Polish Entry'}
            </Button>
          </CardFooter>
        </form>
      </Card>
